...
string expressionToString(ExpressionType type)
{
    ...
    case EXPRESSION_TYPE_AGGREGATE_COMPACT_COUNT_DISTINCT: {
        return "AGGREGATE_COMPACT_COUNT_DISTINCT";
    }
    case EXPRESSION_TYPE_AGGREGATE_VALUES_TO_COMPACT: {
        return "AGGREGATE_VALUES_TO_COMPACT";
    }
...
ExpressionType stringToExpression(string str )
{
    ...
    } else if (str == "AGGREGATE_COMPACT_COUNT_DISTINCT") {
        return EXPRESSION_TYPE_AGGREGATE_COMPACT_COUNT_DISTINCT;
    } else if (str == "AGGREGATE_VALUES_TO_COMPACT") {
